...
module.exports = function (db, name) {
  ...
  function embed(resource, e) {
    e && [].concat(e).forEach(function (externalResource) {
      if (db.get(externalResource).value) {
        ...
        query[singularResource + 'Id'] = resource.data.id;
  ...
  function list(req, res, next) {
    // Resource chain
    var chain = db.get(name).get("data");
    ...
    Object.keys(req.query).forEach(function (query) {
      var arr = db.get(name).get("data").value();
  ...
  function show(req, res, next) {
    var _embed = req.query._embed;
    var _expand = req.query._expand;
    var resource = db.get(name).get("data").getById(req.params.id).value();
  ...
  function destroy(req, res, next) {
    var resource = db.get(name).get("data").removeById(req.params.id).value();
